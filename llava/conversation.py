...
class Conversation:
    ...
    def get_prompt(self):
        ...
        elif self.sep_style == SeparatorStyle.TELECHAT:
...
conv_telechat = Conversation(
    system="""<_system>你是一个AI智能助手。""",
    roles=("<_user>", "<_bot>"),
    version="telechat",
    messages=[],
    offset=0,
    sep_style=SeparatorStyle.TELECHAT,
    sep="",
    sep2="<_end>"
)

default_conversation = conv_vicuna_v0
#default_conversation = conv_telechat
